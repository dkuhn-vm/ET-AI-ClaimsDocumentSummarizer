...
def summarize_incident(text: str, model_name: str = "gemma") -> str:
    """
    Summarizes a single incident using an Ollama model and a specific prompt.
    
    :param text: The full text of the incident to be summarized.
    ...
    system_prompt = """
        ...
        Your task is to summarize individual incidents reported by users or generated by monitoring systems.
        The summary should be concise but cover key points such as the issue, its cause, impact, and resolution.
        """
    
    user_prompt = f"Summarize the following incident:\n\n{text}\n\nPlease provide a concise summary for software development and QA leaders."
...
def summarize_trend(combined_text: str, model_name: str = "gemma") -> str:
    ...
    :param model_name: The name of the Ollama model to use.
    :return: A summarized string that captures trends and patterns across incidents.
    """
    # Define a different system prompt for summarizing trends across incidents
    system_prompt = """
        You are an AI assistant tasked with analyzing patterns and trends from multiple incident reports.
        Your goal is to provide a high-level summary that highlights common issues, recurring problems, and overall trends 
        across many incidents. The summary should be targeted at helping software development and QA teams 
        understand overarching themes, risks, and areas for improvement.
        """
    
    user_prompt = f"Summarize the following combined incident summaries:\n\n{combined_text}\n\nPlease provide a high-level trend summary for development and QA leaders."
